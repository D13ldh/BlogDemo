	...
	<body>
		...
		<div class="top">
			<div class="top-box">
				...
				<!--search begin-->
				<div class="search">
					<form action="editType.do" method="post">
			...
			<div class="main-box">
				...
				<div class="main-content">
					...
					<div class="mainform_box">
						<form action="editType.do" method="post">
							<label>分类标题：</label>
							<p><input type="text" name="title_editInfo" class="text" value="Java"/></p>
							<input type="hidden" name="id_editInfo" value="<%=request.getParameter("id") %>"/>
