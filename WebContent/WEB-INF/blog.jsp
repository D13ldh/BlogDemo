...
<%
	...
	VO4AllTypeName[] TypeList  = (VO4AllTypeName[])session.getAttribute("BlogTypeList");
	//获取热门博客
			...
			<div class="main-sidebar">
				...
				<div class="side_box">
					...
					<div class="side_list">
						<ul>
						<%
						for(VO4AllTypeName tmp:TypeList){ %>
							<li><a href="blog_view.jsp?id=<%=tmp.getTypeId()%>"><%=tmp.getName()%></a>
							<a href="type_edit.jsp?id=<%=tmp.getTypeId()%>" class="a2">【改】</a> <a
								href="" class="a2">【删】</a>
							</li>
						<%} %>	
						</ul>
